...
<html>
<head>
    <title><cst:localeTag key="admin.edit_pickup.title" /></title>
...
<body>
    ...
    <main role="main" class="container bg-light admin-main-form">
        <h3 class="row justify-content-center mb-4">
            <cst:localeTag key="admin.edit_pickup.title" />
        </h3>
        <form action="${pageContext.request.contextPath}/controller?command=update_pickup" method="post">
            ...
            <div class="form-outline mb-3">
                <label class="form-group" for="ni"><cst:localeTag key="admin.pickups.name" /></label>
                <input id="ni" type="text" name="name" placeholder=<cst:localeTag key="placeholder.name" /> required  value="${requestScope.pickup.name}"
